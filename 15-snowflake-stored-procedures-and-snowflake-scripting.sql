...
CREATE SCHEMA IF NOT EXISTS SQUIRREL_DB.STORED_PROCS;
USE SCHEMA SQUIRREL_DB.STORED_PROCS;
...
CALL CHANGEWHSIZESQL('SQUIRREL_wh', 'small');
...
CALL CHANGEWHSIZESQL('SQUIRREL_wh_wh', 'xlarge');
...
CALL CHANGEWHSIZESQL('SQUIRREL_wh', 'verysmall');
