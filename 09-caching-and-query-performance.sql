...
--         suspended, you may get an error. This is normal. You simply need to
--         restart the virtual warehouse and continue your work.
...
-- 9.6.0   Review the output from EXPLAIN
...
-- 9.6.3   Use EXPLAIN to see the plan for the second query.
