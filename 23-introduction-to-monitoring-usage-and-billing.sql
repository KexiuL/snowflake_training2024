...
--         You shouldn’t find any virtual warehouses without resource monitors
--         because they all have at least one. So, your result should be zero.
--         However, if you have not added a resource monitor to your own virtual
--         warehouse (SQUIRREL_WH), then that virtual warehouse may appear in the
--         results. Ideally, there should be a resource monitor for all virtual
