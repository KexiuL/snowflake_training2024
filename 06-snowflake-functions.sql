...
--         complete as many as you can in the time allotted by your instructor.
...
--         information_schema.query_history() in SQUIRREL_DB.
...
--         table function in SQUIRREL_DB to list the types of queries executed
...
CREATE OR REPLACE TABLE SQUIRREL_T(ID INTEGER);
INSERT INTO SQUIRREL_T (ID) VALUES (1);
UPDATE SQUIRREL_T SET ID = 2;
UPDATE SQUIRREL_T SET ID = 1;
DELETE FROM SQUIRREL_T WHERE ID = 1;
INSERT INTO SQUIRREL_T (ID) VALUES (3);
TRUNCATE TABLE SQUIRREL_T;
...
-- 6.5.8   Write a query that uses the information_schema.query_history() table
